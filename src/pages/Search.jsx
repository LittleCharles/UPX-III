...
export function Search() {
  ...
  return (
    <>
      ...
      <div>
        <center><Button className="margin-top:30px  text-white hover:bg-white hover:text-primary border border-primary" onClick={returnHome}>Voltar ao início</Button></center>
      </div>
    </>
  );
};
